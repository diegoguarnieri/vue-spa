<template>
<div class="sidebar sidebar-dark sidebar-fixed sidebar-self-hiding-lg" id="sidebar">
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/8.jpg"></div></a>
        ...
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/1.jpg"><span class="avatar-status bg-success"></span></div>
        </td>
        <td>
        ...
        <tr class="align-middle">
        <td class="text-center">
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/2.jpg"><span class="avatar-status bg-danger"></span></div>
        </td>
        <td>
        ...
        <tr class="align-middle">
        <td class="text-center">
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/3.jpg"><span class="avatar-status bg-warning"></span></div>
        </td>
        <td>
        <div>Quintin Ed</div>
        <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1, 2020</div>
        ...
        <tr class="align-middle">
        <td class="text-center">
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/4.jpg"><span class="avatar-status bg-secondary"></span></div>
        </td>
        <td>
        ...
        <tr class="align-middle">
        <td class="text-center">
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/5.jpg"><span class="avatar-status bg-success"></span></div>
        </td>
        <td>
        ...
        <tr class="align-middle">
        <td class="text-center">
        <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/6.jpg"><span class="avatar-status bg-danger"></span></div>
        </td>
        <td>
        ...
        <footer class="footer">
        <div><a href="https://">CoreUI </a><a href="https://">Bootstrap Admin Template</a> &copy; 2021 creativeLabs.</div>
